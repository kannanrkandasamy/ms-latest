      ...
      <div className="container text-center" style={{ textAlign: "justify" }}>
        ...
        <div>
          <p style={{ textAlign: "justify" }}>
            Thank you for your interest in MegaSails website/Platform. MegaSails
            appreciates your interest in our company products and services we
            offer. We strongly recommend that, as you read this
            ...
            other content that you submit to us or post on MegaSails
            Website/Platform. You are responsible for maintaining the required
            confidentiality of any information of MegaSails utilized in
          ...
          <p style={{ textAlign: "justify" }}>
            MegaSails reserve the right to change, modify, delete the
            ...
            periodically check of all changes posted. MegaSails Website/Platform
            reserve the right to change, terminate any access provided,
            suspend/discontinue, the Website/platform or parts of
            ...
            applicable law or is harmful to the interests of MegaSails
            website/Platform, to its customers and affiliates or licensing
            partners.
          </p>
          <p style={{ textAlign: "justify" }}>
            MegaSails Website/Platform owns all the intellectual property rights
            of the MegaSails Logo, Software programming source code, site
            framework, content created, text, page layouts rendering pages,
            ...
            US and other countries trade secret laws. To download MegaSails
          ...
          <p style={{ textAlign: "justify" }}>
            By using the advertising services offered in MegaSails
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            MegaSails Website/Platform all of the text, pictures, graphics,
            ...
            conformance with MegaSails Advertisement Specifications. For ad
            specs click here In submitting Advertising to MegaSails
            Website/Platform, the Customer, Ad Sponsors/Advertisement networking
            agencies grants MegaSails Website/Platform a worldwide,
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            and managed upon the end of the relationship between MegaSails
            Website/Platform and the customer/Ad Sponsor/ Digital advertisement
            network agencies. MegaSails Website/Platform reserves all rights to
            reject, deny, cancel, revise, change the position of ad space, and
            remove any advertisement we consider inappropriate, misleading,
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            provided to MegaSails Website/Platform or created by
            Website/Platform on behalf of the customer/Ad Sponsor/Advertising
            network agencies.
          </p>
          <p style={{ textAlign: "justify" }}>
            Content developed/created for publishing by MegaSails website
            ...
            person/team members. MegaSails Website/Platform makes no guarantees
            as to the number of visitors to the site or the number of
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            which may harm MegaSails Website/platform and it users end user
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            confidential information owned by MegaSails Web Site/Platform and
            will not be disclosed by the digital advertisers networking agencies
            to any third party without MegaSails Web Site/Platform’s written
            consent. MegaSails Website/Platform does not guarantee continuous,
            uninterrupted access, secure access of the website/Platform by
            users, MegaSails will use reasonable efforts to keep the site
            available online beyond the reasonable control of MegaSails.
            MegaSails Website/Platform will not be liable for any delay or
            failure to publish/post the Advertising caused by a factor outside
            of MegaSails Website/Platform control, such as adverse climate
            conditions, fire, war, civil disorder/unrest, accident, terrorism,
            regulatory restrictions, epidemic, pandemic, sanctions, power and
            network outages, judicial orders, and any other circumstance.
          </p>
          <p style={{ textAlign: "justify" }}>
            Digital Advertiser, Advertising Network Agencies, Interest based
            advertisers may cancel an Advertisement in writing to MegaSails. The
            minimum notice period for cancellation by the Advertiser is 30 days
            unless agreed otherwise. MegaSails Website/Platform shall not be
            responsible, under any circumstances, for any loss or damage
            suffered which could not be contemplated by MegaSails
            ...
            MegaSails Website/Platform maximum total liability for any loss or
            damage arising out of or in relation to any Advertisement whether in
            contract or otherwise shall not exceed the total amount of the
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            Based Advertisers, Blog contributors will indemnify MegaSails
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            manner with a valid payment method. MegaSails Website/Platform will
            invoice the Digital Advertiser, Advertising Network Agencies,
          ...
          <p style={{ textAlign: "justify" }}>
            ...
            past due by 90 days of the payment terms to MegaSails
            ...
            counsel. During the amount collection, MegaSails Website/Platform
